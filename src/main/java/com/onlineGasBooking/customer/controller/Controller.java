...
public class Controller {
	...
	public String deleteCustomer(@PathVariable long id) throws CustomerNotPresentException {
		logger.info("Customer Deleted Successfully");
		return cusServ.deleteCustomer(id);
	}
	
	
	@GetMapping("/getCustomerCylinderById/{id}")
	public ResponseEntity<ApiResponse> getCusCylinderById(@PathVariable long id) throws CustomerNotPresentException{
		ApiResponse apiResponse =	cusServ.getCusCylinderById(id);
